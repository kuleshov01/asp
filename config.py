...
custom_expiration_date = '12.12.2025'  # Установите значение в формате 'DD.MM.YYYY' для использования пользовательской даты

# Флаг для пересчета месяца, даже если уже были начисления
recalculate_month = True  # Установите в True, чтобы пересчитывать услуги даже если уже были начисления в этом месяце
